...
class AlienInvasion:
    """Ogólna klasa do zarządania zasobami i sposobem działania gry"""
    ...
    def _check_events(self):
        """Reakcja na zdarzenia generowane przez przycisk"""
    ...
    def _check_play_button(self, mouse_pos):
        ...
        if button_clicked and not self.stats.game_active:
            #Wyzerowanie danych dotyczących gry
    ...
    def _create_fleet(self):
        ...
        #Utworzenie obcego i ustalenie liczby floty obcych, którzy zmieszczą się w rzędzie
    ...
    def _update_screen(self):
        ...
        #Wyświetlenie przycisku tylko wtedy, ggdy gra jest nieaktywna
    ...
    def _ship_hit(self):
        ...
        if self.stats.ships_left > 0:
            #Zmniejszenie wartości przechowywanej w ship_left i uaktualnienie tablicy wyników
